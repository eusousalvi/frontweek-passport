...
!(function (A, e) {
      ...
      return function (A) {
        return (function (e) {
          ...
          for (; o; )
            try {
              if (
                ((n = 1), B && (s = 2 & e[0] ? B.return : e[0] ? B.throw || ((s = B.return) && s.call(B), 0) : B.next) && !(s = s.call(B, e[1])).done)
              )
                return s;
  ...
  var s =
    ((o.prototype.get = function (A) {
      ...
      if (0 <= A) {
        ...
        if (A < this.highStart)
          return (e = 2080 + (A >> 11)), (e = this.index[e]), (e += (A >> 5) & 63), (e = ((e = this.index[e]) << 2) + (31 & A)), this.data[e];
  ...
  function w(A, e, t, r, n) {
    ...
    if (
      (-1 !== [M, b].indexOf(i) && (c === D || (-1 !== [O, f].indexOf(c) && e[1 + o] === D))) ||
      (-1 !== [O, f].indexOf(i) && c === D) ||
      (i === D && -1 !== [D, y, v].indexOf(c))
    )
      return Y;
        ...
        return (
          A.forEach(function (A, e) {
            ...
            if (
              ...
              -1 !== ["normal", "auto", "loose"].indexOf(n) && -1 !== [8208, 8211, 12316, 12448].indexOf(A))
            )
  ...
  var CA = { type: sA.LEFT_PARENTHESIS_TOKEN },
    ...
    OA = { type: sA.SEMICOLON_TOKEN },
    vA = { type: sA.LEFT_SQUARE_BRACKET_TOKEN },
    ...
    MA =
      ...
      (yA.prototype.consumeToken = function () {
        ...
        switch (A) {
          ...
          case 85:
            ...
            return (
              43 !== u || (!aA(U) && 63 !== U) || (this.consumeCodePoint(), this.consumeUnicodeRangeToken()),
      ...
      (yA.prototype.consumeUrlToken = function () {
        ...
        if (39 === t || 34 === t) {
          ...
          return r.type === sA.STRING_TOKEN && (this.consumeWhiteSpace(), -1 === this.peekCodePoint(0) || 41 === this.peekCodePoint(0))
          ...
          if (cA(n))
            return (
              ...
              -1 === this.peekCodePoint(0) || 41 === this.peekCodePoint(0)
                ? (this.consumeCodePoint(), { type: sA.URL_TOKEN, value: l.apply(void 0, A) })
                : (this.consumeBadUrlRemnants(), IA)
            );
      ...
      (yA.prototype.consumeStringToken = function (A) {
        for (var e = "", t = 0; ; ) {
          var r = this._value[t];
          if (-1 === r || void 0 === r || r === A) return (e += this.consumeStringSlice(t)), { type: sA.STRING_TOKEN, value: e };
      ...
      (yA.prototype.consumeNumericToken = function () {
        ...
        return 37 === r
          ? (this.consumeCodePoint(), { type: sA.PERCENTAGE_TOKEN, number: e, flags: t })
  ...
  var Be = function (A, e) {
      return (
        (e === sA.LEFT_CURLY_BRACKET_TOKEN && A.type === sA.RIGHT_CURLY_BRACKET_TOKEN) ||
        (e === sA.LEFT_SQUARE_BRACKET_TOKEN && A.type === sA.RIGHT_SQUARE_BRACKET_TOKEN) ||
        (e === sA.LEFT_PARENTHESIS_TOKEN && A.type === sA.RIGHT_PARENTHESIS_TOKEN)
      );
    },
  ...
  function Ue(A, e, t) {
    return t < 0 && (t += 1), 1 <= t && (t -= 1), t < 1 / 6 ? (e - A) * t * 6 + A : t < 0.5 ? e : t < 2 / 3 ? 6 * (e - A) * (2 / 3 - t) + A : A;
  }
  function le(A) {
    var e = A.filter(kA),
      t = e[0],
  ...
  var me = {
    ...
    ve = {
      get SUPPORT_RANGE_BOUNDS() {
        ...
        return Object.defineProperty(ve, "SUPPORT_RANGE_BOUNDS", { value: A }), A;
      },
      get SUPPORT_SVG_DRAWING() {
        ...
        return Object.defineProperty(ve, "SUPPORT_SVG_DRAWING", { value: A }), A;
      },
      get SUPPORT_FOREIGNOBJECT_DRAWING() {
        var A =
          "function" == typeof Array.from && "function" == typeof window.fetch
                ...
                return (
                  ...
                  Oe(t)
                    .then(function (A) {
                      ...
                      return (
                        (t.style.backgroundImage = "url(" + s + ")"), (t.style.height = "100px"), Te(e) ? Oe(Le(n, n, 0, 0, t)) : Promise.reject(!1)
                      );
                    })
                    .then(function (A) {
            ...
            : Promise.resolve(!1);
        return Object.defineProperty(ve, "SUPPORT_FOREIGNOBJECT_DRAWING", { value: A }), A;
      },
      get SUPPORT_CORS_IMAGES() {
        var A = void 0 !== new Image().crossOrigin;
        return Object.defineProperty(ve, "SUPPORT_CORS_IMAGES", { value: A }), A;
      },
      get SUPPORT_RESPONSE_TYPE() {
        var A = "string" == typeof new XMLHttpRequest().responseType;
        return Object.defineProperty(ve, "SUPPORT_RESPONSE_TYPE", { value: A }), A;
      },
      get SUPPORT_CORS_XHR() {
        var A = "withCredentials" in new XMLHttpRequest();
        return Object.defineProperty(ve, "SUPPORT_CORS_XHR", { value: A }), A;
      },
    },
    De =
        ...
        return S(this, function (A) {
          switch (A.label) {
            case 0:
              return (
                (e = Se.isSameOrigin(s)),
                (r = !ke(s) && !0 === this._options.useCORS && ve.SUPPORT_CORS_IMAGES && !e),
                (t = !ke(s) && !e && "string" == typeof this._options.proxy && ve.SUPPORT_CORS_XHR && !r),
                e || !1 !== this._options.allowTaint || ke(s) || t || r ? ((n = s), t ? [4, this.proxy(n)] : [3, 2]) : [2]
              );
            case 1:
              (n = A.sent()), (A.label = 2);
            case 2:
              return (
                De.getInstance(this.id).debug("Added image " + s.substring(0, 256)),
                [
                  4,
        ...
        return (
          WA(A).forEach(function (A, e) {
            ...
            if (t.type === sA.FUNCTION)
              ...
              } else if ("to" === t.name) (r = we(t.values[0])), s.push({ stop: ie, color: r });
              else if ("color-stop" === t.name) {
                var n = t.values.filter(kA);
                if (2 === n.length) {
                  r = we(n[1]);
                  var B = n[0];
                  VA(B) && s.push({ stop: { type: sA.PERCENTAGE_TOKEN, number: 100 * B.number, flags: B.flags }, color: r });
                }
              }
          }),
          o === xe.LINEAR_GRADIENT ? { angle: (e + Qe(180)) % Qe(360), stops: s, type: o } : { size: r, shape: t, stops: s, position: [], type: o }
        );
      },
    },
    Qt = {
  ...
  function Et(A) {
    return { name: "border-" + A + "-color", initialValue: "transparent", prefix: !1, type: Ce.TYPE_VALUE, format: "color" };
  }
  function Ft(A) {
    return {
    ...
    Rr = {
      ...
      parse: function (A) {
        return 1 === A.length && JA(A[0], "none")
          ? []
          : WA(A).map(function (A) {
              for (var e = { color: He.TRANSPARENT, offsetX: se, offsetY: se, blur: se }, t = 0, r = 0; r < A.length; r++) {
                var n = A[r];
  ...
  var Vr,
    ...
    qr = { name: "font-size", initialValue: "0", prefix: !1, type: Ce.TYPE_VALUE, format: "length" },
    Zr = {
      name: "font-weight",
      initialValue: "normal",
      type: Ce.VALUE,
  ...
  var en = {
    ...
    sn = {
      ...
      parse: function (A) {
        return 1 === A.length && JA(A[0], "none")
          ? []
          : WA(A).map(function (A) {
              for (var e = { color: 255, offsetX: se, offsetY: se, blur: se, spread: se, inset: !1 }, t = 0, r = 0; r < A.length; r++) {
                var n = A[r];
                JA(n, "inset")
                  ? (e.inset = !0)
                  : YA(n)
                  ? (0 === t ? (e.offsetX = n) : 1 === t ? (e.offsetY = n) : 2 === t ? (e.blur = n) : (e.spread = n), t++)
                  : (e.color = we(n));
              }
              return e;
            });
    ...
    on =
      ((an.prototype.isVisible = function () {
      ...
      (an.prototype.isInlineLevel = function () {
        return (
          $r(this.display, 4) ||
          $r(this.display, 33554432) ||
          $r(this.display, 268435456) ||
          $r(this.display, 536870912) ||
          $r(this.display, 67108864) ||
          $r(this.display, 134217728)
        );
      }),
      an);
  function an(A) {
    (this.backgroundClip = un(me, A.backgroundClip)),
      ...
      (this.boxShadow = un(sn, A.boxShadow)),
      (this.color = un(Xt, A.color)),
      (this.display = un(Jt, A.display)),
      (this.float = un(Zt, A.cssFloat)),
      (this.fontFamily = un(Yr, A.fontFamily)),
      (this.fontSize = un(qr, A.fontSize)),
      (this.fontStyle = un(en, A.fontStyle)),
      (this.fontVariant = un(jr, A.fontVariant)),
      (this.fontWeight = un(Zr, A.fontWeight)),
    ...
    (this.overflowX = e[0]),
      ...
      (this.textTransform = un(vr, A.textTransform)),
  ...
  var cn,
    ...
    Un = function (A) {
      (this.styles = new on(window.getComputedStyle(A, null))),
        (this.textNodes = []),
        (this.elements = []),
        null !== this.styles.transform && wB(A) && (A.style.transform = "none"),
        (this.bounds = T(A)),
        (this.flags = 0);
    },
    ln = function (A, e) {
    ...
    Fn = function (A, e) {
      for (
        var t,
          ...
          })(A, { lineBreak: e.lineBreak, wordBreak: e.overflowWrap === Ur.BREAK_WORD ? "break-word" : e.wordBreak }),
          n = [];
        !(t = r.next()).done;
    ...
    hn = function (A, e) {
      (this.text = Hn(A.data, e.textTransform)),
  ...
  function Nn(A) {
    ...
    return (
      (e.src = A.currentSrc || A.src), (e.intrinsicWidth = A.naturalWidth), (e.intrinsicHeight = A.naturalHeight), Se.getInstance().addImage(e.src), e
    );
  }
  var Kn,
    In = (A(Tn, (Kn = Un)), Tn);
  ...
  function Ln(A) {
    var e = mn.call(this, A) || this,
      t = new XMLSerializer();
    return (
      (e.svg = "data:image/svg+xml," + encodeURIComponent(t.serializeToString(A))),
  ...
  var yn,
    _n = [{ type: sA.DIMENSION_TOKEN, flags: 0, unit: "px", number: 3 }],
    Pn = [{ type: sA.PERCENTAGE_TOKEN, flags: 0, number: 50 }],
    xn = "checkbox",
    Vn = "radio",
    zn = "password",
    Xn = 707406591,
  ...
  function Gn(A) {
    ...
    switch (
      ...
      (e.type !== xn && e.type !== Vn) ||
        ...
        (e.styles.borderTopStyle = e.styles.borderRightStyle = e.styles.borderBottomStyle = e.styles.borderLeftStyle = ht.SOLID),
    ...
    try {
      if (A.contentWindow && A.contentWindow.document && A.contentWindow.document.documentElement) {
        ...
        var t = A.contentWindow.document.documentElement
            ? $n(getComputedStyle(A.contentWindow.document.documentElement).backgroundColor)
            : He.TRANSPARENT,
    ...
    BB = function (A, e, t) {
      for (var r = A.firstChild, n = void 0; r; r = n)
        if (((n = r.nextSibling), cB(r) && 0 < r.data.trim().length)) e.textNodes.push(new hn(r, e.styles));
          ...
          var B = sB(r);
          B.styles.isVisible() &&
            (iB(r, B, t) ? (B.flags |= 4) : aB(B.styles) && (B.flags |= 2),
            -1 !== nB.indexOf(r.tagName) && (B.flags |= 8),
            e.elements.push(B),
            dB(r) || gB(r) || fB(r) || BB(r, B, t));
        }
    },
    sB = function (A) {
      return hB(A)
    ...
    PB =
      ...
      (xB.prototype.cloneNode = function (A) {
        ...
        if (e && QB(A) && (wB(A) || uB(A))) {
          ...
          for (var s = this.counters.parse(new wn(r)), o = this.resolvePseudoContent(A, t, n, LB.BEFORE), i = A.firstChild; i; i = i.nextSibling)
            (QB(i) &&
              ("SCRIPT" === i.tagName ||
                i.hasAttribute(_B) ||
                ("function" == typeof this.options.ignoreElements && this.options.ignoreElements(i)))) ||
              (this.options.copyStyles && QB(i) && rB(i)) ||
          ...
          return (
            a && t.appendChild(a),
            this.counters.pop(s),
            r && (this.options.copyStyles || uB(A)) && !HB(A) && GB(r, t),
  ...
  var is,
    ...
    cs = function (A) {
      ...
      (this.topLeftBorderBox = 0 < n || 0 < B ? us(t.left, t.top, n, B, is.TOP_LEFT) : new ts(t.left, t.top)),
        (this.topRightBorderBox = 0 < o || 0 < i ? us(t.left + g, t.top, o, i, is.TOP_RIGHT) : new ts(t.left + t.width, t.top)),
        (this.bottomRightBorderBox = 0 < c || 0 < Q ? us(t.left + F, t.top + E, c, Q, is.BOTTOM_RIGHT) : new ts(t.left + t.width, t.top + t.height)),
        (this.bottomLeftBorderBox = 0 < u || 0 < U ? us(t.left, t.top + h, u, U, is.BOTTOM_LEFT) : new ts(t.left, t.top + t.height)),
        (this.topLeftPaddingBox =
          0 < n || 0 < B ? us(t.left + p, t.top + H, Math.max(0, n - p), Math.max(0, B - H), is.TOP_LEFT) : new ts(t.left + p, t.top + H)),
        (this.topRightPaddingBox =
          0 < o || 0 < i
            ? us(t.left + Math.min(g, t.width + p), t.top + H, g > t.width + d ? 0 : o - d, i - H, is.TOP_RIGHT)
            : new ts(t.left + t.width - d, t.top + H)),
        (this.bottomRightPaddingBox =
          0 < c || 0 < Q
            ? us(t.left + Math.min(F, t.width - p), t.top + Math.min(E, t.height + H), Math.max(0, c - d), Q - f, is.BOTTOM_RIGHT)
            : new ts(t.left + t.width - d, t.top + t.height - f)),
        (this.bottomLeftPaddingBox =
          0 < u || 0 < U ? us(t.left + p, t.top + h, Math.max(0, u - p), U - f, is.BOTTOM_LEFT) : new ts(t.left + p, t.top + t.height - f)),
        ...
        (this.topRightContentBox =
          0 < o || 0 < i
            ? us(t.left + Math.min(g, t.width + p + T), t.top + H + N, g > t.width + p + T ? 0 : o - p + T, i - (H + N), is.TOP_RIGHT)
        ...
        (this.bottomLeftContentBox =
          0 < u || 0 < U
            ? us(t.left + p + T, t.top + h, Math.max(0, u - (p + T)), U - (f + I), is.BOTTOM_LEFT)
  ...
  function Fs(A, e) {
    if (
      ...
      A.styles.opacity < 1 && this.effects.push(new Cs(A.styles.opacity)),
  ...
  var Ns = function (c, Q, w, u) {
    ...
    Ts = function (A, e, t) {
      ...
      if (zA(s) && (s.value === Ut.CONTAIN || s.value === Ut.COVER))
        return ps(B) ? (t.width / t.height < B != (s.value === Ut.COVER) ? [t.width, t.width / B] : [t.height * B, t.height]) : [t.width, t.height];
      var a = ps(r),
        c = ps(n),
        Q = a || c;
      if (fs(s) && (!o || fs(o)))
      ...
      if (
        ...
        null === U || (o && !fs(o)) || (l = a && c ? (U / r) * n : t.height),
                ...
                (A.slice(0)
                  ...
                  .forEach(function (A) {
                    (s.ctx.shadowColor = te(A.color)),
                      ...
                      s.ctx.fillText(r.text, r.bounds.left, r.bounds.top + r.bounds.height);
                  }),
                (s.ctx.shadowColor = ""),
          ...
          switch (A.label) {
            ...
            case 14:
              if (
                (e instanceof Jn &&
                  ...
                  e.type === xn
                    ? e.checked &&
                      (this.ctx.save(),
                      this.path([
                        new ts(e.bounds.left + 0.39363 * i, e.bounds.top + 0.79 * i),
                        new ts(e.bounds.left + 0.16 * i, e.bounds.top + 0.5549 * i),
                        new ts(e.bounds.left + 0.27347 * i, e.bounds.top + 0.44071 * i),
                        new ts(e.bounds.left + 0.39694 * i, e.bounds.top + 0.5649 * i),
                        new ts(e.bounds.left + 0.72983 * i, e.bounds.top + 0.23 * i),
                        new ts(e.bounds.left + 0.84 * i, e.bounds.top + 0.34085 * i),
                        new ts(e.bounds.left + 0.39363 * i, e.bounds.top + 0.79 * i),
                      ]),
                      (this.ctx.fillStyle = te(Xn)),
                      this.ctx.fill(),
                      this.ctx.restore())
                    : e.type === Vn &&
                      e.checked &&
                ...
                (c = U.add(a, 0, 0, -U.height / 2 + 1)),
                  ...
                  this.ctx.clip(),
                  this.renderTextWithLetterSpacing(new ln(e.value, c), r.letterSpacing),
                  this.ctx.restore(),
            ...
            case 19:
              l.listValue &&
                ...
                this.renderTextWithLetterSpacing(new ln(l.listValue, U), r.letterSpacing),
                (this.ctx.textBaseline = "bottom"),
                (this.ctx.textAlign = "left")),
                (A.label = 20);
            case 20:
    ...
    (bs.prototype.formatPath = function (A) {
      ...
      A.forEach(function (A, e) {
        ...
        0 === e ? r.ctx.moveTo(t.x, t.y) : r.ctx.lineTo(t.x, t.y),
          os(A) && r.ctx.bezierCurveTo(A.startControl.x, A.startControl.y, A.endControl.x, A.endControl.y, A.end.x, A.end.y);
      });
    }),
    ...
    (bs.prototype.renderBackgroundImage = function (b) {
      return a(this, void 0, void 0, function () {
        ...
        return S(this, function (A) {
          switch (A.label) {
            case 0:
              (v = b.styles.backgroundImage.length - 1),
                (e = function (e) {
                  ...
                  return S(this, function (A) {
                    switch (A.label) {
                      ...
                      case 4:
                        return (
                          t &&
                            ((n = ds(b, v, [t.width, t.height, t.width / t.height])),
                            (g = n[0]),
                            (f = n[1]),
                            (p = n[2]),
                            (h = n[3]),
                            (H = n[4]),
                            (l = D.ctx.createPattern(D.resizeImage(t, h, H), "repeat")),
                      ...
                      case 5:
                        !(function (A) {
                          ...
                          ? (function (A) {
                              ...
                              switch (A.size) {
                                case Bt.CLOSEST_SIDE:
                                  A.shape === rt.CIRCLE
                                    ...
                                    : A.shape === rt.ELLIPSE &&
                                      ((B = Math.min(Math.abs(e), Math.abs(e - r))), (s = Math.min(Math.abs(t), Math.abs(t - n))));
                                  break;
                                ...
                                case Bt.FARTHEST_SIDE:
                                  A.shape === rt.CIRCLE
                                    ...
                                    : A.shape === rt.ELLIPSE &&
                                      ((B = Math.max(Math.abs(e), Math.abs(e - r))), (s = Math.max(Math.abs(t), Math.abs(t - n))));
                                  break;
                            ...
                            0 < K &&
                              0 < K &&
                              ((T = D.ctx.createRadialGradient(E + f, F + p, 0, E + f, F + p, K)),
                              ...
                              K !== I
                                ? ((m = b.bounds.left + 0.5 * b.bounds.width),
                                  ...
                                  D.ctx.translate(-m, -R),
                                  D.ctx.fillRect(E, O * (F - R) + R, h, H * O),
                                  D.ctx.restore())
                                : D.ctx.fill()))
                          : ((B = ds(b, v, [null, null, null])),
                            (g = B[0]),
                            (f = B[1]),
                            (p = B[2]),
                            (h = B[3]),
                            ...
                            (u.fillStyle = U),
                            u.fillRect(0, 0, h, H),
                            0 < h && 0 < H && ((l = D.ctx.createPattern(w, "repeat")), D.renderRepeat(g, l, f, p))),
                          (A.label = 6);
                      case 6:
                        return v--, [2];
                    }
          ...
          switch (A.label) {
            case 0:
              return (
                ...
                (n = Ms(ms(e.backgroundClip, 0), c.curves)),
                t || e.boxShadow.length
                  ? (this.ctx.save(),
                    this.path(n),
                    this.ctx.clip(),
                    ee(e.backgroundColor) || ((this.ctx.fillStyle = te(e.backgroundColor)), this.ctx.fill()),
              ...
              A.sent(),
                ...
                e.boxShadow
                  ...
                  .forEach(function (A) {
                    ...
                    A.inset ? (a.path(e), a.ctx.clip(), a.mask(r)) : (a.mask(e), a.ctx.clip(), a.path(r)),
                      ...
                      (a.ctx.fillStyle = A.inset ? te(A.color) : "rgba(0,0,0,1)"),
                      a.ctx.fill(),
                      a.ctx.restore();
                  }),
                (A.label = 2);
  ...
  function bs(A) {
    (this._activeEffects = []),
      ...
      (this.fontMetrics = new Os(document)),
        ...
        switch (A.label) {
          case 0:
            ...
            return (
              ...
              (o = n.left),
              (i = n.top),
              (a = K({}, { allowTaint: !1, imageTimeout: 15e3, proxy: void 0, useCORS: !1 }, N)),
              (c = {
          ...
          case 1:
            return (
              (l = A.sent()),
              (C = e.documentElement ? xs(getComputedStyle(e.documentElement).backgroundColor) : He.TRANSPARENT),
              (g = e.body ? xs(getComputedStyle(e.body).backgroundColor) : He.TRANSPARENT),
              (E = N.backgroundColor),
              (F = "string" == typeof E ? xs(E) : null === E ? He.TRANSPARENT : 4294967295),
              ...
              Q.foreignObjectRendering
                ? (De.getInstance(r).debug("Document cloned, using foreign object rendering"), [4, new _s(H).render(U)])
                : [3, 3]
            );
          case 2:
            return (d = A.sent()), [3, 5];
          case 3:
            return (
              De.getInstance(r).debug("Document cloned, using computed rendering"),
              Se.attachInstance(Q.cache),
              De.getInstance(r).debug("Starting DOM parsing"),
              (f = oB(U)),
              Se.detachInstance(),
              h === f.styles.backgroundColor && (f.styles.backgroundColor = He.TRANSPARENT),
          ...
          case 5:
            return (
              !0 === Q.removeContainer && (PB.destroy(l) || De.getInstance(r).error("Cannot detach cloned iframe as it is not in the DOM anymore")),
